...
public class ConsoleGrid {
    ...
    public ConsoleGrid(int rowSize, int colSize) {
	this.rowSize = rowSize;
	this.colSize = colSize;
	this.gridOfOrganisms = new Organism[rowSize][colSize];
    }
	...
	this.colSize = copy.getColSize();
	Organism[][] copyGrid = copy.getGrid();
	this.gridOfOrganisms = new Organism[copyGrid.length][copyGrid[0].length];
